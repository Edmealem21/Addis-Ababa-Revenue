...
import { FaBell, FaClipboardCheck, FaFileInvoice } from 'react-icons/fa';
  ...
  const stats = [
    {
      ...
      value: 9,
      icon: <FaBell className="text-2xl text-amber-600 dark:text-amber-400" />,
      borderColor: 'border-amber-500/30',
      badgeBg: 'bg-amber-100 dark:bg-amber-900/40',
    },
    {
      id: 'evaluated-records',
      title: t('evaluatedRecords'),
      value: 84,
      icon: <FaClipboardCheck className="text-2xl text-emerald-600 dark:text-emerald-400" />,
