...
import { FaTachometerAlt, FaBell, FaClipboardList, FaFileInvoice } from 'react-icons/fa';
...
const OfficerLayout = () => {
  ...
  const officerMenuItems = [
    { path: '/officer/dashboard', label: t('dashboard'), icon: <FaTachometerAlt /> },
    {
      key: 'notifies',
      label: t('taxNotifies'),
      icon: <FaBell />,
      children: [
        { path: '/officer/taxnotifies/unevaluated', label: t('unevaluated'), icon: <FaClipboardList /> },
        { path: '/officer/taxnotifies/all', label: t('allNotifies'), icon: <FaFileInvoice /> },
      ],
    },
  ];
