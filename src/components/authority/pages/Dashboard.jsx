...
import { FaClock, FaCheckCircle, FaTimesCircle, FaFileInvoice } from 'react-icons/fa';
...
const Dashboard = () => {
  ...
  const stats = [
    ...
    {
      id: 'approved-records',
      title: t('approvedRecords'),
      value: 128,
      icon: <FaCheckCircle className="text-2xl text-emerald-600 dark:text-emerald-400" />,
      borderColor: 'border-emerald-500/30',
      badgeBg: 'bg-emerald-100 dark:bg-emerald-900/40',
    },
    {
      id: 'rejected-records',
      title: t('rejectedRecords'),
      value: 6,
      icon: <FaTimesCircle className="text-2xl text-rose-600 dark:text-rose-400" />,
